              ...
              <div className="flex">
                <div className="flex flex-col">
                  ...
                  <form onChange={setInput}>
                    ...
                    <button
                      type="button"
                      className="p-2 rounded-md ml-5 border-greeen border-solid border-2 opacity-75 cursor-pointer hover:scale-125 transition transform duration-100 ease-out font-bold text-xs  hover:bg-yellow-400 hover:text-white "
                      onClick={newPlaylist}
                    >
                      Create
                    </button>
