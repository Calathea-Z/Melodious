...
//-----Place provider info you need here.
export const authOptions = {
  ...
  providers: [
    SpotifyProvider({
      ...
      // special auth info from Spotify stored in lib folder
  ...
  //This will allow for continuos login refresh by creating a
  callbacks: {
    //destructuring the jwt object
